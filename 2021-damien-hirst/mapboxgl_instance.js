...
const geojson = {
  ...
  },
  {
    ...
    properties: {
      ...
      moreInfoUrl: '/two-figures-with-a-drum',
      markerColor: '#f36f23',
      moveAside: false,
...
window.onload = () => {
  ...
  geojson.features.forEach(function(marker) {
    ...
    const popupContent = `
      ...
      <p class="popupExhibitionType">
        <a href="${marker.properties.moreInfoUrl}" style="margin-bottom:12px">
          ${marker.properties.exhibitionType}
        </a>
      </p>
    `;
